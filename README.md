...
episode.get_current_episode_name() # вернет название аниме + сезон + серия "Ванпанчмен 1 сезон 1 серия"
episode.get_title() # вернет реальное название серии "Ванпанчмен 1 серия: сильнейший человек"
