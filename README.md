# jut.su Parser - набор методов для парсинга аниме с сайта jut.su
### Репозиторий со списком всех аниме с сайта jut.su (регулярно обновляю): https://github.com/Neito3350/animeJSON
